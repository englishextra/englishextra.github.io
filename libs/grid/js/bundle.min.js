...
(function (btn, page, container, item, active_vk_like, active_share, active_sidepanel, active_menumore) {
	...
	if (b && e && p && c) {
		...
		if ("undefined" !== typeof earlyHasTouch && "touch" === earlyHasTouch) {
			evento.add(c, "swipeleft", h_p_left);
			/* p.onswipeleft = h_p_left; */
 ...
 * init ui-totop
 */
(function (u, active, t, mi1, mi2, mi3) {
	"use strict";
	var w = window,
	b = BALA.one("body") || "",
	h = BALA.one("html") || "",
	...
	("ui-totop", "is-active", "Наверх", "mi", "mi-Up", "mi-lg"));
/*!
 * init manUP.js
 */
