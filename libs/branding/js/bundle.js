...
(function(root, document) {
	...
	var run = function run() {
		...
		var initAllMasonry = function initAllMasonry() {
			...
			var initScript = function initScript() {
				if (root.Masonry) {
					...
					var initMsnry = function initMsnry(e) {
						msnry = new Masonry(e, {
					...
					if (root.Packery) {
						...
						var initPckry = function initPckry(e) {
							pckry = new Packery(e, {
								itemSelector: gridItemSelector,
								columnWidth: gridSizerSelector,
								gutter: 0,
		...
		var initPrettyPrint = function initPrettyPrint() {
		...
		var handleSourceCodeLayerAll = function handleSourceCodeLayerAll() {
			var _this = this;
		...
		var manageSourceCodeLayers = function manageSourceCodeLayers(scope) {
			var ctx = scope && scope.nodeName ? scope : "";
		...
		var initDownloadAppBtn = function initDownloadAppBtn() {
			var navigatorUserAgent = navigator.userAgent || "";
