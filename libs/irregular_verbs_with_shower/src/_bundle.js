...
isElectron, isNwjs, loadDeferred, loadJsCss, manageExternalLinkAll,
needsPolyfills, openDeviceBrowser, parseLink, removeClass, require,
scroll2Top, setDisplayNone, supportsCanvas, supportsPassive,
supportsSvgSmilAnimation, throttle, toggleClass, ToProgress, VK, Ya*/
...
(function(root, document) {
    ...
    var urlArray = ["../../libs/irregular_verbs_with_shower/css/bundle.min.css"];
