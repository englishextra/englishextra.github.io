 ...
 * scrollToPos(p,t)
 */
(function(root){var scrollToPos=function(p,t){t=t||200;if(p){if(root.zenscroll){zenscroll.toY(p,t);}else{root.scroll(0,p);}}return!1;};root.scrollToPos=scrollToPos;}(globalRoot));
/*!
