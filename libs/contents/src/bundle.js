...
loadJsCss, addListener, removeListener, getByClass, addClass, hasClass, removeClass, toggleClass, Masonry, Packery,
Promise, QRCode, require, ToProgress, unescape, verge, VK, Ya*/
...
(function (root, document) {
	...
	var load;
	load = new loadJsCss(["../libs/contents/css/bundle.min.css"], onFontsLoaded);
})("undefined" !== typeof window ? window : this, document);
