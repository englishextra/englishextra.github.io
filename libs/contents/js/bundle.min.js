...
Draggabilly, findPos, fixEnRuTypo, getByClass, getHumanDate,
getObjectKeyValue, hasClass, isNodejs, isElectron, isNwjs, isValidId, Kamil,
LazyLoad, loadDeferred, loadJsCss, manageDataSrcIframeAll,
manageDataSrcImgAll, manageExternalLinkAll, manageLocationQrcode,
manageSearchInput, Masonry, needsPolyfills, openDeviceBrowser, Packery,
parseLink, prependFragment, QRCode, removeChildren, removeClass, require,
...
(function (root, document) {
			...
			var processJsonResponse = function (responseText) {
				...
				var generateContentsOptions = function (e) {
					...
					if (label && link) {
						...
						contentsOption.appendChild(document.createTextNode("" + label));
	...
	var urlArray = ["../libs/contents/css/bundle.min.css"];
