...
(function(a,c){var e=c.documentElement||"",f=c.body||"",d=new ToProgress({id:"top-progress-bar",color:"#FF2C40",height:"0.200rem",duration:.2,zIndex:999});d.increase(20);var b="ontouchstart"in e||"",u="onwheel"in c.createElement("div")||void 0!==c.onmousewheel||"",A=function(c){var b=a.location.protocol||"";return"http:"===b?"http":"https:"===b?"https":c?"http":""},B=A(!0),C=function(){var m=c.title||"",L=a.location.href||"",g=navigator.userAgent||"";d.increase(20);e&&e.classList&&(e.classList.remove("no-js"),
...
typeof require||"",O="undefined"!==typeof a&&a.process&&"renderer"===a.process.type||"",y;a:{if("undefined"!==typeof g&&g)try{if("undefined"!==typeof require("nw.gui")){y=!0;break a}}catch(k){}y=!1}var C=function(k){var c=function(){var a=O?require("electron").shell:"";return a?a.openExternal(k):""},b=function(){var a=y?require("nw.gui").Shell:"";return a?a.openExternal(k):""};O?c():y?b():(c=a.location.protocol||"",(!c||"http:"!==c&&"https:"!==c)&&a.open(k,"_system","scrollbars=1,location=no"))},
E=function(a,c){var b,d,N,e;return function(){N=this;d=[].slice.call(arguments,0);e=new Date;var p=function(){var f=new Date-e;f<c?b=setTimeout(p,c-f):(b=null,a.apply(N,d))};b||(b=setTimeout(p,c))}},z=function(a,c){function b(){p=0;g=+new Date;f=a.apply(d,e);e=d=null}var d,e,f,p,g=0;return function(){d=this;e=arguments;var a=new Date-g;p||(a>=c?b():p=setTimeout(b,c-a));return f}},D=function(c,b,d){function M(){m+=1/60;var c=m/h,b=l[p](c);1>c?(requestAnimationFrame(M),a.scrollTo(0,f+(g-f)*b)):a.scrollTo(0,
g)}var f=a.scrollY||e.scrollTop,g=c||0,p=d||"easeOutSine",m=0,h=Math.max(.1,Math.min(Math.abs(f-g)/(b||2E3),.8)),l={easeOutSine:function(a){return Math.sin(Math.PI/2*a)},easeInOutSine:function(a){return-.5*(Math.cos(Math.PI*a)-1)},easeInOutQuint:function(a){return 1>(a/=.5)?.5*Math.pow(a,5):.5*(Math.pow(a-2,5)+2)}};M()},P=function(a){var b,d,e;b=c.getElementsByTagName("script")||"";d=0;for(e=b.length;d<e;d+=1)if(b[d].getAttribute("src")===a)return!0;return!1},Q=c.getElementsByClassName("wrapper")[0]||
"";(function(a){a=(a=a&&a.nodeName?a:"")?a.getElementsByTagName("a")||"":c.getElementsByTagName("a")||"";var b=function(a){var c=function(a,c){c.stopPropagation();c.preventDefault();var b=C.bind(null,a);E(b,200)()};if(!a.classList.contains("is-binded")&&!a.target&&!a.rel){var b=a.getAttribute("href")||"";b&&v(b).isCrossDomain&&v(b).hasHTTP&&(a.title=""+(v(b).hostname||"")+" откроется в новой вкладке","undefined"!==typeof A&&A()?(a.target="_blank",a.rel="noopener"):a.addEventListener("click",c.bind(null,
b)),a.classList.add("is-binded"))}};if(a){var d,e;d=0;for(e=a.length;d<e;d+=1)b(a[d]);d=e=null}})(Q);var W=function(a,b,d){b=c.getElementById(b)||"";d=c.getElementById(d)||"";return(a=-1!==["boolean","number","string","symbol","function"].indexOf(typeof a)?JSON.parse(a):a)&&b&&d?(new t(b.innerHTML||"")).render(a):{}},X=function(a,b,d){var e=c.body||"",f=function(){return d&&"function"===typeof d&&d()};try{var g=b.cloneNode(!1);if(c.createRange){var m=c.createRange();m.selectNode(e);var l=m.createContextualFragment(a);
g.appendChild(l);return b.parentNode?b.parentNode.replaceChild(g,b):b.innerHTML=a,f()}g.innerHTML=a;return b.parentNode?b.parentNode.replaceChild(c.createDocumentFragment.appendChild(g),b):b.innerHTML=a,f()}catch(h){console.log(h)}},Y=function(a,b,d,e,f){f=f||"";var g=c.getElementById(b)||"",m=c.getElementById(d)||"",l=function(){return e&&"function"===typeof e&&e()};a&&g&&m&&(a=W(a,b,d),f?(m.innerHTML=a,l()):X(a,m,l))},Z=function(a){var b=0,c;for(c in a)a.hasOwnProperty(c)&&++b;return b},aa=function(a){return new Promise(function(b,
c){var d;try{if(d=JSON.parse(a),d.pages[0].src)if(d.pages[0].width){if(!d.pages[0].height)throw Error("incomplete JSON data: no height");if(!d.pages[0].title)throw Error("incomplete JSON data: no title");}else throw Error("incomplete JSON data: no width");else throw Error("incomplete JSON data: no src");}catch(e){console.log("cannot init generateGallery",e);return}var f=Z(d.pages);Y(d,"template_zoomwall","target_zoomwall",function(){Q.getElementsByClassName("data-src-img")[f-1]?b():c()},!0)})},F,
ba=function(){clearTimeout(F);F=null;zoomwall.create(x,!0,"src",null,function(){x.style.visibility="visible";x.style.opacity=1})},G,ca=function(){clearTimeout(G);G=null;echo("data-src-img","src")},g=new Headers;fetch("./libs/contents-cards/json/contents.json",{headers:g,credentials:"same-origin"}).then(function(a){if(a.ok)return a.text();throw Error("cannot fetch","./libs/contents-cards/json/contents.json");}).then(function(a){aa(a).then(function(a){return a}).then(function(){F=setTimeout(ba,200)}).then(function(){G=
setTimeout(ca,200)})["catch"](function(a){console.log("Cannot create zoomwall gallery",a)})})["catch"](function(a){console.log("cannot parse","./libs/contents-cards/json/contents.json",a)});var H=function(a){a=a||this;var b=c.getElementsByClassName("is-social")||"";if(b){var d,e;d=0;for(e=b.length;d<e;d+=1)a!==b[d]&&b[d].classList.remove("is-active")}};a.addEventListener("click",H);var I=c.getElementById("ya-share2")||"",l=(g=c.getElementsByClassName("btn-share")[0]||"")?g.getElementsByTagName("a")[0]||
"":"",J,r=function(b){b.preventDefault();b.stopPropagation();E(function(){I.classList.toggle("is-active");H(I);var b=function(){if(a.Ya)try{J?J.updateContent({title:m,description:m,url:L}):J=Ya.share2("ya-share2",{content:{title:m,description:m,url:L}})}catch(b){}},c=B+"://yastatic.net/share2/share.js";P(c)?b():new loadJsCss([c],b)},200)()};g&&l&&I&&l.addEventListener("click",r);var R=c.getElementsByClassName("vk-like")[0]||"",S=c.getElementsByClassName("holder-vk-like")[0]||"",l=(g=c.getElementsByClassName("btn-like")[0]||
"")?g.getElementsByTagName("a")[0]||"":"",T,r=function(b){b.preventDefault();b.stopPropagation();E(function(){S.classList.toggle("is-active");H(S);var b=function(){if(a.VK&&!T)try{VK.init({apiId:R.dataset.apiid||"",nameTransportPath:"/xd_receiver.htm",onlyWidgets:!0}),VK.Widgets.Like("vk-like",{type:"button",height:24}),T=!0}catch(b){}},c=B+"://vk.com/js/api/openapi.js?147";P(c)?b():new loadJsCss([c],b)},200)()};g&&l&&R&&l.addEventListener("click",r);var q=c.getElementsByClassName("title-bar")[0]||
"",K=q.offsetHeight||0,U=function(){z(function(){q.classList.remove("is-fixed");(c.body.scrollTop||e.scrollTop||0)>K?q.classList.add("is-hidden"):q.classList.remove("is-hidden")},100)()},V=function(){z(function(){q.classList.remove("is-hidden");(c.body.scrollTop||e.scrollTop||0)>K?q.classList.add("is-fixed"):q.classList.remove("is-fixed")},100)()},g=function(){z(function(){(c.body.scrollTop||e.scrollTop||0)<K&&(q.classList.remove("is-hidden"),q.classList.remove("is-fixed"))},100)()};q&&(a.addEventListener("scroll",
g,{passive:!0}),b?a.tocca&&(a.addEventListener("swipeup",U,{passive:!0}),a.addEventListener("swipedown",V,{passive:!0})):u&&a.WheelIndicator&&new WheelIndicator({elem:a,callback:function(a){"down"===a.direction&&U();"up"===a.direction&&V()},preventMouse:!1}));g=c.getElementsByClassName("btn-totop")[0]||"";l=function(a){a.stopPropagation();a.preventDefault();D(0,2E4)};r=function(a){z(function(){var b=c.getElementsByClassName("btn-totop")[0]||"",d=a.pageYOffset||e.scrollTop||f.scrollTop||"",g=a.innerHeight||
e.clientHeight||f.clientHeight||"";d&&g&&b&&(d>g?b.classList.add("is-active"):b.classList.remove("is-active"))},100)()};g&&(g.addEventListener("click",l),a.addEventListener("scroll",r,{passive:!0}))},v=["./libs/picturewall/css/bundle.min.css"];(function(){var b=!1;try{var c=Object.defineProperty&&Object.defineProperty({},"passive",{get:function(){b=!0}});a.addEventListener("test",function(){},c)}catch(d){}return b})()&&a.requestAnimationFrame&&a.matchMedia&&("undefined"!==typeof a.Element||"dataset"in
e)&&"classList"in c.createElement("_")&&(!c.createElementNS||"classList"in c.createElementNS("http://www.w3.org/2000/svg","g"))&&(!a.attachEvent||a.addEventListener)&&"onhashchange"in a&&Array.prototype.indexOf&&a.Promise&&a.fetch&&c.querySelectorAll&&c.querySelector&&Function.prototype.bind&&(!(Object.defineProperty&&Object.getOwnPropertyDescriptor&&Object.getOwnPropertyDescriptor(Element.prototype,"textContent"))||Object.getOwnPropertyDescriptor(Element.prototype,"textContent").get)&&"undefined"!==
typeof a.localStorage&&"undefined"!==typeof a.sessionStorage&&a.WeakMap&&a.MutationObserver||v.push("../../cdn/polyfills/js/polyfills.fixed.min.js");v.push("./libs/picturewall/js/vendors.min.js");var D=function(){var a=c.createElement("canvas");return!(!a.getContext||!a.getContext("2d"))}();loadCSS(B+"://fonts.googleapis.com/css?family=Roboto:400,700&subset=cyrillic",function(){var a,b=function(){clearInterval(a);a=null;d.increase(20);new loadJsCss(v,C)},c=function(){doesFontExist("Roboto")&&b()};
D?a=setInterval(c,100):(a=null,b())})})("undefined"!==typeof window?window:this,document);
