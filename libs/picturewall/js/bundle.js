...
(function(root, document) {
	...
	var run = function run() {
		...
		var zoomwallGallery =
			document[getElementsByClassName](zoomwallGalleryClass)[0] || "";
		...
		var generateGallery = function generateGallery(text) {
			return new Promise(function(resolve, reject) {
				...
				insertFromTemplate(
					...
					function() {
						if (
							wrapper[getElementsByClassName](dataSrcImgClass)[
								pagesKeysNumber - 1
							]
						) {
							resolve();
		...
		var createGallery = function createGallery() {
			...
			var onZoomwallCreated = function onZoomwallCreated() {
