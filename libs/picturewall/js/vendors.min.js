...
!function(n){"use strict";function t(n){return new Option(n).text[o](/"/g,"&quot;")}function r(n,t){for(var r=t.split(".");r[u];){if(!(r[0]in n))return!1;n=n[r.shift()]}return n}function e(n,u){return n[o](f,function(n,t,o,f,c,a,s,p){var l,v=r(u,f),h="";if(!v)return"!"===o?e(c,u):s?e(p,u):"";if(!o)return e(a,u);if("@"===o){n=u._key,t=u._val;for(l in v)v[i](l)&&(u._key=l,u._val=v[l],h+=e(c,u));return u._key=n,u._val=t,h}}).replace(c,function(n,e,i){var o=r(u,i);return o||0===o?"%"===e?t(o):o:""})}var i="hasOwnProperty",u="length",o="replace",f=/\{\{(([@!]?)(.+?))\}\}(([\s\S]+?)(\{\{:\1\}\}([\s\S]+?))?)\{\{\/\1\}\}/g,c=/\{\{([=%])(.+?)\}\}/g,a=function(n){this.t=n};a.prototype.render=function(n){return e(this.t,n)},n.t=a}("undefined"!=typeof window?window:this);
!function(t,n){"use strict";t.echo=function(e,i,r){var c=e||"data-src-img",o=i||"src",s=r||100,u=function(t){var n=this;n.elem=t,n.render(),n.listen()},a=n.documentElement.classList.contains("is-binded-echo")||"",d=[],f=function(e){var i=e.getBoundingClientRect();return(i.top>=0&&i.left>=0&&i.top)<=(t.innerHeight||n.documentElement.clientHeight)},l=function(t,n){t.src=t.dataset[o]||t.getAttribute("data-"+o),n&&n()},v=function(t,n){-1!==d.indexOf(t)&&d.splice(n,1)},h=function(){for(var t=0;t<d.length;t++){var n=d[t];f(n)&&l(n,v(n,t))}},m=function(t,n){function e(){o=0,s=+new Date,c=t.apply(i,r),i=null,r=null}var i,r,c,o,s=0;return function(){i=this,r=arguments;var t=new Date-s;return o||(t>=n?e():o=setTimeout(e,n-t)),c}}(h,s),p=function(){var n=!1;try{var e=Object.defineProperty&&Object.defineProperty({},"passive",{get:function(){n=!0}});t.addEventListener("test",function(){},e)}catch(t){}return n}();u.prototype={init:function(){d.push(this.elem)},render:function(){h()},listen:function(){a||(t.addEventListener("scroll",m,!!p&&{passive:!0}),n.documentElement.classList.add("is-binded-echo"))}};var g=n.getElementsByClassName(c)||"";g&&function(){for(var t=0;t<g.length;t++)new u(g[t]).init()}()}}("undefined"!=typeof window?window:this,document);
!function(e,t){"use strict";var r="style",a={create:function(e,t,r,i,n){var s=this;s.dataAttributeHighresName=r||"highres",s.dataAttributeLowresName=i||"lowres",a.resize(e.children),e.classList.remove("loading"),e.addEventListener("click",function(){s.children&&s.children.length>0&&a.shrink(s.children[0])});for(var o=0;o<e.children.length;o++)e.children[o].addEventListener("click",a.animate);t&&a.keys(e),"function"==typeof n&&n(e)},keys:function(e){var r=function(r){if(!r.defaultPrevented){var i=e||t.getElementsByClassName("zoomwall lightbox")[0];if(i)switch(r.keyCode){case 27:i.children&&i.children.length>0&&a.shrink(i.children[0]),r.preventDefault();break;case 37:a.page(i,!1),r.preventDefault();break;case 39:a.page(i,!0),r.preventDefault()}}};return t.addEventListener("keydown",r),r},resizeRow:function(t,a){if(t&&t.length>1)for(var i in t)t.hasOwnProperty(i)&&(t[i][r].width=parseInt(e.getComputedStyle(t[i]).width,10)/a*100+"%",t[i][r].height="auto")},calcRowWidth:function(t){var r=0;for(var a in t)t.hasOwnProperty(a)&&(r+=parseInt(e.getComputedStyle(t[a]).width,10));return r},resize:function(e){for(var t=[],r=-1,i=0;i<e.length;i++){var n=e[i];n&&(-1===r?r=n.offsetTop:n.offsetTop!==r&&(a.resizeRow(t,a.calcRowWidth(t)),t=[],r=n.offsetTop),t.push(n))}a.resizeRow(t,a.calcRowWidth(t))},reset:function(e){e[r].transform="translate(0, 0) scale(1)",e[r].webkitTransform="translate(0, 0) scale(1)",e.classList.remove("active")},shrink:function(e){e.parentNode.classList.remove("lightbox"),a.reset(e);for(var t=e.previousElementSibling;t;)a.reset(t),t=t.previousElementSibling;for(var r=e.nextElementSibling;r;)a.reset(r),r=r.nextElementSibling;e.dataset.lowres&&(e.src=e.dataset.lowres)},expand:function(t){var a=this;t.classList.add("active"),t.parentNode.classList.add("lightbox");var i=e.getComputedStyle(t.parentNode),n=parseInt(i.width,10),s=parseInt(i.height,10),o=t.parentNode.getBoundingClientRect().top,l=e.getComputedStyle(t),d=parseInt(l.width,10),f=parseInt(l.height,10),h=e.innerHeight;s<e.innerHeight?h=s:o>0&&(h-=o),t.dataset[a.dataAttributeHighresName]&&(t.src!==t.dataset[a.dataAttributeHighresName]&&void 0===t.dataset[a.dataAttributeLowresName]&&(t.dataset[a.dataAttributeLowresName]=t.src),t.src=t.dataset[a.dataAttributeHighresName]);var g=[];g.push(t);for(var p=t.nextElementSibling;p&&p.offsetTop===t.offsetTop;)g.push(p),p=p.nextElementSibling;for(var c=t.previousElementSibling;c&&c.offsetTop===t.offsetTop;)g.unshift(c),c=c.previousElementSibling;var m=h/f;d*m>n&&(m=n/d);var v=o-t.parentNode.offsetTop+t.offsetTop;(s<e.innerHeight||f*m<s)&&(v-=h/2-f*m/2),o>0&&(v-=o);for(var u=0,w=0;w<g.length&&g[w]!==t;w++)u+=parseInt(e.getComputedStyle(g[w]).width,10)*m;u=n/2-d*m/2-u;for(var b=0,x=g.length-1;x>=0&&g[x]!==t;x--)b+=parseInt(e.getComputedStyle(g[x]).width,10)*m;b=n/2-d*m/2-b;for(var S=0,y=0,E=0;E<g.length;E++){var k=((S+=y*m-y)+u)/(y=parseInt(e.getComputedStyle(g[E]).width,10))*100,C=-v/parseInt(e.getComputedStyle(g[E]).height,10)*100;g[E][r].transformOrigin="0% 0%",g[E][r].webkitTransformOrigin="0% 0%",g[E][r].transform="translate("+k.toFixed(8)+"%, "+C.toFixed(8)+"%) scale("+m.toFixed(8)+")",g[E][r].webkitTransform="translate("+k.toFixed(8)+"%, "+C.toFixed(8)+"%) scale("+m.toFixed(8)+")"}var F,T=f*(m-1)-v;S=0,y=0;for(var N=g[g.length-1].nextElementSibling,I=-1;N;){var L=N.offsetTop;L===I?S+=y*m-y:(-1!==I&&(S=0,T+=F*(m-1)),I=L);var O=(S+u)/(y=parseInt(e.getComputedStyle(N).width,10))*100,z=T/(F=parseInt(e.getComputedStyle(N).height,10))*100;N[r].transformOrigin="0% 0%",N[r].webkitTransformOrigin="0% 0%",N[r].transform="translate("+O.toFixed(8)+"%, "+z.toFixed(8)+"%) scale("+m.toFixed(8)+")",N[r].webkitTransform="translate("+O.toFixed(8)+"%, "+z.toFixed(8)+"%) scale("+m.toFixed(8)+")",N=N.nextElementSibling}var A=-v;S=0,y=0;for(var H=g[0].previousElementSibling,R=-1;H;){var B=H.offsetTop;B===R?S-=y*m-y:(S=0,A-=parseInt(e.getComputedStyle(H).height,10)*(m-1),R=B);var P=(S-b)/(y=parseInt(e.getComputedStyle(H).width,10))*100,D=A/parseInt(e.getComputedStyle(H).height,10)*100;H[r].transformOrigin="100% 0%",H[r].webkitTransformOrigin="100% 0%",H[r].transform="translate("+P.toFixed(8)+"%, "+D.toFixed(8)+"%) scale("+m.toFixed(8)+")",H[r].webkitTransform="translate("+P.toFixed(8)+"%, "+D.toFixed(8)+"%) scale("+m.toFixed(8)+")",H=H.previousElementSibling}},animate:function(e){var t=this;if(t.classList.contains("active"))a.shrink(t);else{for(var r=t.parentNode.getElementsByClassName("active"),i=0;i<r.length;i++)r[i].classList.remove("active");a.expand(t)}e.stopPropagation()},page:function(e,t){var r=e.getElementsByClassName("active");if(r&&r.length>0){var i,n=r[0];(i=t?n.nextElementSibling:n.previousElementSibling)&&(n.classList.remove("active"),n.dataset.lowres&&(n.src=n.dataset.lowres),a.expand(i))}}};e.zoomwall=a}("undefined"!=typeof window?window:this,document);
