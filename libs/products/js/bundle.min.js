...
earlyDeviceType, earlyDeviceFormfactor, prependFragment, getHumanDate,
isNodejs, isElectron, supportsPassive, supportsSvgSmilAnimation,
supportsCanvas, manageExternalLinkAll, needsPolyfills, openDeviceBrowser,
isNwjs, appendFragment, removeChildren, setDisplayBlock, setDisplayNone,
debounce, DoSlide, loadJsCss, loadDeferred, parseLink, addListener, ajaxGet,
getByClass, addClass, hasClass, removeClass, toggleClass, QRCode, require,
...
(function (root, document) {
	...
	var urlArray = ["../../libs/products/css/bundle.min.css"];
