/*jslint browser: true */
/*jslint node: true */
/*global doesFontExist, prependFragmentBefore, getHumanDate, isNodejs,
isElectron, supportsPassive, supportsSvgSmilAnimation, supportsCanvas,
needsPolyfills, forcedHTTP, openDeviceBrowser, isNwjs, appendFragment,
removeChildren, setDisplayBlock, setDisplayNone, debounce, DoSlide, loadJsCss,
loadDeferred, parseLink, addListener, getByClass, addClass, hasClass,
...
(function (root, document) {
	...
	loadDeferred(["../../libs/products/css/bundle.min.css"], loadOnFontsReady.bind(null, bodyFontFamily, null));
})("undefined" !== typeof window ? window : this, document);
