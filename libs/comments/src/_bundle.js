...
/*global $, addClass, addListener, ajaxGet, debounce, doesFontExist,
earlySvgSupport, earlySvgasimgSupport, earlyHasTouch, earlyDeviceType,
earlyDeviceFormfactor, getByClass, getHumanDate, hasClass, isNodejs,
isElectron, isNwjs, jQuery, loadDeferred, loadJsCss, manageExternalLinkAll,
...
(function (root, document) {
	...
	var urlArray = ["../libs/comments/css/bundle.min.css"];
