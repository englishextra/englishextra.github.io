...
loadInitComments = function () {
	"use strict";
	var w = window,
	js = "../libs/comments/js/vendors.min.js";
	if (w.XMLHttpRequest || w.ActiveXObject) {
		if (w.Promise) {
			promiseLoadJS(js).then(initComments);
		} else {
			ajaxLoadTriggerJS(js, initComments);
		}
	} else {
...
docReady(manageCommentsTextarea);
/*!
 * init nav-menu
 */
