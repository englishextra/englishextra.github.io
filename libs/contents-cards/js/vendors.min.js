...
!function(t,e){"use strict";function i(t,e){for(var i in e)e.hasOwnProperty(i)&&(t[i]=e[i]);return t}var n=function(t){var n=t.container instanceof Node?t.container:e.getElementById(t.container)||e.getElementsByClassName(t.container)[0]||"",s=t.item instanceof NodeList?t.item:n.getElementsByClassName(t.item)||"";this.props=i(t,{container:n,nodeList:s})};n.prototype.mount=function(){if(!this.props.container)return!1;if(!this.props.nodeList||0===this.props.nodeList.length)return!1;var t="number"==typeof this.props.gutter&&isFinite(this.props.gutter)&&Math.floor(this.props.gutter)===this.props.gutter?this.props.gutter:0,e=this.props.done,i=this.props.container,n=this.props.nodeList;i.style.width="";var s=Array.prototype.forEach,r=i.getBoundingClientRect().width,o=n[0].getBoundingClientRect().width+t,p=Math.max(Math.floor((r-t)/o),1),a=0;r=o*p+t+"px",i.style.width=r,i.style.position="relative";for(var l=[],h=[],c=0;c<p;++c)h.push(c*o+t),l.push(t);this.props.rtl&&h.reverse(),s.call(n,function(e){var i=l.slice(0).sort(function(t,e){return t-e}).shift();i=l.indexOf(i);var n=parseInt(h[i]),s=parseInt(l[i]);e.style.position="absolute",e.style.webkitBackfaceVisibility=e.style.backfaceVisibility="hidden",e.style.transformStyle="preserve-3d",e.style.transform="translate3D("+n+"px,"+s+"px, 0)",l[i]+=e.getBoundingClientRect().height+t,a+=1}),i.style.display="";var u=l.slice(0).sort(function(t,e){return t-e}).pop();i.style.height=u+"px","function"==typeof e&&e(n)},t.Minigrid=n}("undefined"!=typeof window?window:this,document);
