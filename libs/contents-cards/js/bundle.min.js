...
"//"+a.hostname+(a.port?":"+a.port:"")!==g()}(),hasHTTP:/^(http|https):\/\//i.test(y)?!0:!1}}()},m="undefined"!==typeof process&&"undefined"!==typeof require||"",q="undefined"!==typeof a&&a.process&&"renderer"===a.process.type||"",z;a:{if("undefined"!==typeof m&&m)try{if("undefined"!==typeof require("nw.gui")){z=!0;break a}}catch(y){}z=!1}var C=function(b){var c=function(){var a=q?require("electron").shell:"";return a?a.openExternal(b):""},d=function(){var a=z?require("nw.gui").Shell:"";return a?
a.openExternal(b):""};q?c():z?d():(c=a.location.protocol||"",(!c||"http:"!==c&&"https:"!==c)&&a.open(b,"_system","scrollbars=1,location=no"))},x=function(b,a,c){function d(){var h=Date.now()-l;h<a&&0<=h?e=setTimeout(d,a-h):(e=null,c||(k=b.apply(g,f),g=f=null))}var e,f,g,l,k;if(void 0===a||null===a)a=100;var h=function(){g=this;f=arguments;l=Date.now();var h=c&&!e;e||(e=setTimeout(d,a));h&&(k=b.apply(g,f),g=f=null);return k};h.clear=function(){e&&(clearTimeout(e),e=null)};h.flush=function(){e&&(k=
b.apply(g,f),g=f=null,clearTimeout(e),e=null)};return h},K=b.getElementsByClassName("wrapper")[0]||"";(function(a){a=(a=a&&a.nodeName?a:"")?a.getElementsByTagName("a")||"":b.getElementsByTagName("a")||"";var c=function(a){var b=function(a,b){b.stopPropagation();b.preventDefault();var c=C.bind(null,a);x(c,200)()};if(!a.classList.contains("is-binded")&&!a.target&&!a.rel){var c=a.getAttribute("href")||"";c&&r(c).isCrossDomain&&r(c).hasHTTP&&(a.title=""+(r(c).hostname||"")+" откроется в новой вкладке",
"undefined"!==typeof n&&n()?(a.target="_blank",a.rel="noopener"):a.addEventListener("click",b.bind(null,c)),a.classList.add("is-binded"))}};if(a){var d,e;d=0;for(e=a.length;d<e;d+=1)c(a[d]);d=e=null}})(K);var B=b.title||"",m=navigator.userAgent||"",u=function(){var a=new Date,b=a.getDate(),c=a.getFullYear(),a=a.getMonth(),a=a+1;10>b&&(b="0"+b);10>a&&(a="0"+a);return c+"-"+a+"-"+b}(),w="";m&&a.platform&&(w=platform.description||"",b.title=B+" ["+(u?" "+u:"")+(w?" "+w:"")+(f||c?" with":"")+(f?" touch":
...
c[d]&&c[d].classList.remove("is-active")}};a.addEventListener("click",G);var H=b.getElementById("ya-share2")||"",u=(m=b.getElementsByClassName("btn-share")[0]||"")?m.getElementsByTagName("a")[0]||"":"",I,w=function(b){b.preventDefault();b.stopPropagation();x(function(){H.classList.toggle("is-active");G(H);var b=function(){if(a.Ya)try{I?I.updateContent({title:B,description:B,url:L}):I=Ya.share2("ya-share2",{content:{title:B,description:B,url:L}})}catch(b){console.log("cannot update or init Ya",b)}},
c=d+"://yastatic.net/share2/share.js";M(c)?b():new loadJsCss([c],b)},200)()};m&&u&&H&&u.addEventListener("click",w);var N=b.getElementsByClassName("vk-like")[0]||"",O=b.getElementsByClassName("holder-vk-like")[0]||"",u=(m=b.getElementsByClassName("btn-like")[0]||"")?m.getElementsByTagName("a")[0]||"":"",P,w=function(b){b.preventDefault();b.stopPropagation();x(function(){O.classList.toggle("is-active");G(O);var b=function(){if(a.VK&&!P)try{VK.init({apiId:N.dataset.apiid||"",nameTransportPath:"/xd_receiver.htm",
onlyWidgets:!0}),VK.Widgets.Like("vk-like",{type:"button",height:24}),P=!0}catch(b){console.log("cannot init VK",b)}},c=d+"://vk.com/js/api/openapi.js?147";M(c)?b():new loadJsCss([c],b)},200)()};m&&u&&N&&u.addEventListener("click",w);var D=function(a,b){function c(){g=0;h=+new Date;f=a.apply(d,e);e=d=null}var d,e,f,g,h=0;return function(){d=this;e=arguments;var a=new Date-h;g||(a>=b?c():g=setTimeout(c,b-a));return f}},v=b.getElementsByClassName("title-bar")[0]||"",J=v.offsetHeight||0,Q=function(){D(function(){v.classList.remove("is-fixed");
(b.body.scrollTop||b.documentElement.scrollTop||0)>J?v.classList.add("is-hidden"):v.classList.remove("is-hidden")},100)()},R=function(){D(function(){v.classList.remove("is-hidden");(b.body.scrollTop||b.documentElement.scrollTop||0)>J?v.classList.add("is-fixed"):v.classList.remove("is-fixed")},100)()},m=function(){D(function(){(b.body.scrollTop||b.documentElement.scrollTop||0)<J&&(v.classList.remove("is-hidden"),v.classList.remove("is-fixed"))},100)()};v&&(a.addEventListener("scroll",m,{passive:!0}),
...
n={easeOutSine:function(a){return Math.sin(Math.PI/2*a)},easeInOutSine:function(a){return-.5*(Math.cos(Math.PI*a)-1)},easeInOutQuint:function(a){return 1>(a/=.5)?.5*Math.pow(a,5):.5*(Math.pow(a-2,5)+2)}};f()},S=b.body||"",m=b.getElementsByClassName("btn-totop")[0]||"",u=function(a){a.stopPropagation();a.preventDefault();aa(0,2E4)},w=function(a){D(function(){var c=b.getElementsByClassName("btn-totop")[0]||"",d=a.pageYOffset||e.scrollTop||S.scrollTop||"",f=a.innerHeight||e.clientHeight||S.clientHeight||
"";d&&f&&c&&(d>f?c.classList.add("is-active"):c.classList.remove("is-active"))},100)()};m&&(m.addEventListener("click",u),a.addEventListener("scroll",w,{passive:!0}))},e=["./libs/contents-cards/css/bundle.min.css"],d=n(!0);a.MutationObserver||e.push(d+"://cdn.jsdelivr.net/npm/mutation-observer@1.0.3/index.min.js");"classList"in b.createElement("_")||e.push(d+"://cdn.jsdelivr.net/npm/classlist.js@1.1.20150312/classList.min.js");"undefined"!==typeof a.Element&&"dataset"in b.documentElement||e.push(d+
"://cdn.jsdelivr.net/npm/element-dataset@2.2.6/lib/browser/index.cjs.min.js");(function(){var b=!1;try{var c=Object.defineProperty&&Object.defineProperty({},"passive",{get:function(){b=!0}});a.addEventListener("test",function(){},c)}catch(d){}return b})()||e.push(d+"://cdn.jsdelivr.net/npm/dom4@1.8.5/build/dom4.max.min.js");a.Promise||e.push(d+"://cdn.jsdelivr.net/npm/promise-polyfill@6.0.2/promise.min.js");a.fetch||e.push(d+"://cdn.jsdelivr.net/fetch/2.0.1/fetch.min.js");e.push(d+"://cdn.jsdelivr.net/npm/platform@1.3.4/platform.min.js");
f?e.push(d+"://cdnjs.cloudflare.com/ajax/libs/Tocca.js/2.0.1/Tocca.min.js"):c&&e.push("./cdn/wheel-indicator/1.1.4/js/wheel-indicator.fixed.min.js");var q=function(){var a=b.createElement("canvas");return!(!a.getContext||!a.getContext("2d"))}();new loadJsCss([d+"://fonts.googleapis.com/css?family=Roboto:400,700&subset=cyrillic"],function(){var a,b=function(){clearInterval(a);a=null;g.increase(20);new loadJsCss(e,h)},c=function(){doesFontExist("Roboto")&&b()};q?a=setInterval(c,100):(a=null,b())})})("undefined"!==
