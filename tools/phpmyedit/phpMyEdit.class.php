...
class phpMyEdit
{
	...
	function sql_connect() /* {{{ */
	{
		$this->dbh = @ini_get('allow_persistent')
			...
			: @mysql_connect($this->hn, $this->un, $this->pw); 		/* $shimansky */	@mysql_query("SET NAMES 'utf8'");
	} /* }}} */
...
function '.$this->js['prefix'].'filter_handler(theForm, theEvent)
{
	...
	function execute() /* {{{ */
	{
		...
		/* $shimansky set_magic_quotes_runtime(0); http://habrahabr.kz/blog/435.html */ ini_set("magic_quotes_runtime", 0);
