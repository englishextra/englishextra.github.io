...
(function(e,f){var d={create:function(b,a,c,g){var h=this;h.dataAttributeHighresName=c||"highres";h.dataAttributeLowresName=g||"lowres";d.resize(b.children);b.classList.remove("loading");b.addEventListener("click",function(){h.children&&0<h.children.length&&d.shrink(h.children[0])});for(c=0;c<b.children.length;c++)b.children[c].addEventListener("click",d.animate);a&&d.keys(b)},keys:function(b){var a=function(a){if(!a.defaultPrevented){var g=b||f.getElementsByClassName("zoomwall lightbox")[0];if(g)switch(a.keyCode){case 27:g.children&&
...
resize:function(b){for(var a=[],c=-1,g=0;g<b.length;g++){var h=b[g];h&&(-1==c?c=h.offsetTop:h.offsetTop!=c&&(d.resizeRow(a,d.calcRowWidth(a)),a=[],c=h.offsetTop),a.push(h))}d.resizeRow(a,d.calcRowWidth(a))},reset:function(b){b.style.transform="translate(0, 0) scale(1)";b.style.webkitTransform="translate(0, 0) scale(1)";b.classList.remove("active")},shrink:function(b){b.parentNode.classList.remove("lightbox");d.reset(b);for(var a=b.previousElementSibling;a;)d.reset(a),a=a.previousElementSibling;for(a=
b.nextElementSibling;a;)d.reset(a),a=a.nextElementSibling;b.dataset.lowres&&(b.src=b.dataset.lowres)},expand:function(b){b.classList.add("active");b.parentNode.classList.add("lightbox");var a=e.getComputedStyle(b.parentNode),c=parseInt(a.width,10),g=parseInt(a.height,10),h=b.parentNode.getBoundingClientRect().top,a=e.getComputedStyle(b),k=parseInt(a.width,10),f=parseInt(a.height,10),d=e.innerHeight;g<e.innerHeight?d=g:0<h&&(d-=h);b.dataset[this.dataAttributeHighresName]&&(b.src!=b.dataset[this.dataAttributeHighresName]&&
void 0===b.dataset[this.dataAttributeLowresName]&&(b.dataset[this.dataAttributeLowresName]=b.src),b.src=b.dataset[this.dataAttributeHighresName]);var l=[];l.push(b);for(a=b.nextElementSibling;a&&a.offsetTop==b.offsetTop;)l.push(a),a=a.nextElementSibling;for(a=b.previousElementSibling;a&&a.offsetTop==b.offsetTop;)l.unshift(a),a=a.previousElementSibling;a=d/f;k*a>c&&(a=c/k);var m=h-b.parentNode.offsetTop+b.offsetTop;if(g<e.innerHeight||f*a<g)m-=d/2-f*a/2;0<h&&(m-=h);for(g=h=0;g<l.length&&l[g]!=b;g++)h+=
parseInt(e.getComputedStyle(l[g]).width,10)*a;h=c/2-k*a/2-h;g=0;for(d=l.length-1;0<=d&&l[d]!=b;d--)g+=parseInt(e.getComputedStyle(l[d]).width,10)*a;g=c/2-k*a/2-g;for(k=c=b=0;k<l.length;k++){b+=c*a-c;var c=parseInt(e.getComputedStyle(l[k]).width,10),d=(b+h)/c*100,n=-m/parseInt(e.getComputedStyle(l[k]).height,10)*100;l[k].style.transformOrigin="0% 0%";l[k].style.webkitTransformOrigin="0% 0%";l[k].style.transform="translate("+d.toFixed(8)+"%, "+n.toFixed(8)+"%) scale("+a.toFixed(8)+")";l[k].style.webkitTransform=
"translate("+d.toFixed(8)+"%, "+n.toFixed(8)+"%) scale("+a.toFixed(8)+")"}for(var f=f*(a-1)-m,p,c=b=0,k=l[l.length-1].nextElementSibling,d=-1;k;){n=k.offsetTop;n==d?b+=c*a-c:(-1!=d&&(b=0,f+=p*(a-1)),d=n);c=parseInt(e.getComputedStyle(k).width,10);p=parseInt(e.getComputedStyle(k).height,10);var n=(b+h)/c*100,q=f/p*100;k.style.transformOrigin="0% 0%";k.style.webkitTransformOrigin="0% 0%";k.style.transform="translate("+n.toFixed(8)+"%, "+q.toFixed(8)+"%) scale("+a.toFixed(8)+")";k.style.webkitTransform=
"translate("+n.toFixed(8)+"%, "+q.toFixed(8)+"%) scale("+a.toFixed(8)+")";k=k.nextElementSibling}p=-m;c=b=0;l=l[0].previousElementSibling;for(m=-1;l;)h=l.offsetTop,h==m?b-=c*a-c:(b=0,p-=parseInt(e.getComputedStyle(l).height,10)*(a-1),m=h),c=parseInt(e.getComputedStyle(l).width,10),h=(b-g)/c*100,f=p/parseInt(e.getComputedStyle(l).height,10)*100,l.style.transformOrigin="100% 0%",l.style.webkitTransformOrigin="100% 0%",l.style.transform="translate("+h.toFixed(8)+"%, "+f.toFixed(8)+"%) scale("+a.toFixed(8)+
...
b.push(a+"://cdnjs.cloudflare.com/ajax/libs/dom4/1.8.3/dom4.js");e.Promise||b.push(a+"://cdn.jsdelivr.net/es6-promise-polyfill/1.2.0/promise.min.js");e.fetch||b.push(a+"://cdn.jsdelivr.net/fetch/2.0.1/fetch.min.js");new loadJsCss([a+"://fonts.googleapis.com/css?family=Roboto:400&subset=cyrillic"],function(){var a,e=function(){clearInterval(a);a=null;new loadJsCss(b,d)},h=function(){var a=f.createElement("canvas");return!(!a.getContext||!a.getContext("2d"))}();a=setInterval(function(){h?doesFontExist("Roboto")&&
e():e()},100)})})("undefined"!==typeof window?window:this,document);
