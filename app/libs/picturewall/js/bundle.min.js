...
"translate("+d.toFixed(8)+"%, "+n.toFixed(8)+"%) scale("+a.toFixed(8)+")"}for(var f=f*(a-1)-m,p,b=c=0,k=l[l.length-1].nextElementSibling,d=-1;k;){n=k.offsetTop;n==d?c+=b*a-b:(-1!=d&&(c=0,f+=p*(a-1)),d=n);b=parseInt(g.getComputedStyle(k).width,10);p=parseInt(g.getComputedStyle(k).height,10);var n=(c+h)/b*100,q=f/p*100;k.style.transformOrigin="0% 0%";k.style.webkitTransformOrigin="0% 0%";k.style.transform="translate("+n.toFixed(8)+"%, "+q.toFixed(8)+"%) scale("+a.toFixed(8)+")";k.style.webkitTransform=
"translate("+n.toFixed(8)+"%, "+q.toFixed(8)+"%) scale("+a.toFixed(8)+")";k=k.nextElementSibling}p=-m;b=c=0;l=l[0].previousElementSibling;for(m=-1;l;)h=l.offsetTop,h==m?c-=b*a-b:(c=0,p-=parseInt(g.getComputedStyle(l).height,10)*(a-1),m=h),b=parseInt(g.getComputedStyle(l).width,10),h=(c-e)/b*100,f=p/parseInt(g.getComputedStyle(l).height,10)*100,l.style.transformOrigin="100% 0%",l.style.webkitTransformOrigin="100% 0%",l.style.transform="translate("+h.toFixed(8)+"%, "+f.toFixed(8)+"%) scale("+a.toFixed(8)+
...
(function(g){function f(a,c){for(var b=c.split(".");b.length;){if(!(b[0]in a))return!1;a=a[b.shift()]}return a}function d(b,h){return b.replace(c,function(a,c,b,e,g,n,p,q){e=f(h,e);var w="",u;if(!e)return"!"===b?d(g,h):p?d(q,h):"";if(!b)return d(n,h);if("@"===b){a=h._key;c=h._val;for(u in e)e.hasOwnProperty(u)&&(h._key=u,h._val=e[u],w+=d(g,h));h._key=a;h._val=c;return w}}).replace(a,function(a,c,b){return(a=f(h,b))||0===a?"%"===c?(new Option(a)).text.replace(/"/g,"&quot;"):a:""})}var c=/\{\{(([@!]?)(.+?))\}\}(([\s\S]+?)(\{\{:\1\}\}([\s\S]+?))?)\{\{\/\1\}\}/g,
a=/\{\{([=%])(.+?)\}\}/g,b=function(a){this.t=a};b.prototype.render=function(a){return d(this.t,a)};g.t=b})("undefined"!==typeof window?window:this);
(function(g,f){g.echo=function(d,c,a){d=d||"data-src-img";c=c||"src";a=a||100;var b=function(a){this.elem=a;this.render();this.listen()},e=f.documentElement.classList.contains("is-binded-echo")||"",h=[],k=function(){for(var a=0;a<h.length;a++){var b=h[a],e=b.getBoundingClientRect();if((0<=e.top&&0<=e.left&&e.top)<=(g.innerHeight||f.documentElement.clientHeight)){var e=b,d=a;-1!==h.indexOf(b)&&h.splice(d,1);e.src=e.dataset[c]||e.getAttribute("data-"+c)}}},v=function(a,c){function b(){d=0;k=+new Date;
f=a.apply(e,h);h=e=null}var e,h,f,d,k=0;return function(){e=this;h=arguments;var a=new Date-k;d||(a>=c?b():d=setTimeout(b,c-a));return f}}(k,a),r=function(){var a=!1;try{var c=Object.defineProperty&&Object.defineProperty({},"passive",{get:function(){a=!0}});g.addEventListener("test",function(){},c)}catch(b){}return a}();b.prototype={init:function(){h.push(this.elem)},render:function(){k()},listen:function(){e||(g.addEventListener("scroll",v,r?{passive:!0}:!1),f.documentElement.classList.add("is-binded-echo"))}};
...
(function(g,f){var d=function(){var a="ontouchstart"in f[c]||"",b="onwheel"in f.createElement("div")||void 0!==f.onmousewheel||"",d=f.title||"",v=navigator.userAgent||"",r=function(){var a=new Date,b=a.getDate(),c=a.getFullYear(),a=a.getMonth(),a=a+1;10>b&&(b="0"+b);10>a&&(a="0"+a);return c+"-"+a+"-"+b}(),l="";v&&g.platform&&(l=platform.description||"",f.title=d+" ["+(r?" "+r:"")+(l?" "+l:"")+(a||b?" with":"")+(a?" touch":"")+(a&&b?",":"")+(b?" mousewheel":"")+"]");var m=f.getElementsByClassName("zoomwall")[0]||
...
a,d()}h.innerHTML=a;return b.parentNode?b.parentNode.replaceChild(f.createDocumentFragment.appendChild(h),b):b.innerHTML=a,d()}catch(l){console.log(l)}},q=function(a,b,c,e,d){d=d||"";var h=f.getElementById(b)||"",g=f.getElementById(c)||"",k=function(){return e&&"function"===typeof e&&e()};a&&h&&g&&(a=n(a,b,c),d?(g.innerHTML=a,k()):p(a,g,k))},a=new Headers;fetch("./libs/picturewall/json/zoomwall.json",{headers:a,credentials:"same-origin"}).then(function(a){if(a.ok)return a.text();throw Error("cannot fetch",
"./libs/picturewall/json/zoomwall.json");}).then(function(a){(new Promise(function(b,c){var e;try{if(e=JSON.parse(a),!e.images[0].src)throw Error("incomplete JSON data: no src");}catch(d){console.log("cannot init generateGallery",d);return}q(e,"template_zoomwall","target_zoomwall",function(){0<f.getElementsByClassName("data-src-img").length?b():c()},!0)})).then(function(a){return a}).then(function(a){var b;b=setTimeout(function(){clearTimeout(b);b=null;zoomwall.create(m,!0,"src",null,function(){m.style.visibility=
"visible";m.style.opacity=1})},100)}).then(function(a){var b;b=setTimeout(function(){clearTimeout(b);b=null;echo("data-src-img","src")},200)})["catch"](function(a){console.log("Cannot create zoomwall gallery",a)})})["catch"](function(a){console.log("cannot parse","./libs/picturewall/json/zoomwall.json")})},c="documentElement",a=["./libs/picturewall/css/bundle.min.css"],b=function(a){var b=g.location.protocol||"";return"http:"===b?"http":"https:"===b?"https":a?"http":""}(!0);"classList"in f.createElement("_")||
