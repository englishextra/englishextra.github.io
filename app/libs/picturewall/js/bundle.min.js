...
(function(f,g){var e=function(){var a="ontouchstart"in g[b]||"",c="onwheel"in g.createElement("div")||void 0!==g.onmousewheel||"",e=g.title||"",p=navigator.userAgent||"",r=function(){var a=new Date,b=a.getDate(),c=a.getFullYear(),a=a.getMonth(),a=a+1;10>b&&(b="0"+b);10>a&&(a="0"+a);return c+"-"+a+"-"+b}(),h="";p&&f.platform&&(h=platform.description||"",g.title=e+" ["+(r?" "+r:"")+(h?" "+h:"")+(a||c?" with":"")+(a?" touch":"")+(a&&c?",":"")+(c?" mousewheel":"")+"]");var m=g.getElementsByClassName("zoomwall")[0]||
