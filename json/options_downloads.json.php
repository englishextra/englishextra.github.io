...
/* http://www.google.ru/url?sa=t&rct=j&q=&esrc=s&source=web&cd=3&ved=0CGEQFjAC&url=http%3A%2F%2Fshimansky.biz%2Fjson%2Foptions_downloads.json.php&ei=PK8uUO67CIyFhQeI_oH4Dg&usg=AFQjCNGsVayFDHlN_iPNQijbktuzmQA4GQ&sig2=jYX2mJgHP3DCxGqKl_NLWw&cad=rjt */
if (!preg_match("/(http\:\/\/|https\:\/\/)(" . preg_quote($vars2_site_root_printable) . ")/i", $vars2_http_referer)) {
	die();
}
$table_name = $options_downloads_table_name;
 ...
 */
$cache_table_name = "cache_" . $options_downloads_table_name . "_json";
